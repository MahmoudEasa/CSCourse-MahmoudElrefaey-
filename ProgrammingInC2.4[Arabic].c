...
void read6Nums(int *num1, int *num2, int *num3, int *num4, int *num5, int *num6){
    printf("Please Enter 6 Numbers:\n");
    scanf("%d %d %d %d %d %d", num1, num2, num3, num4, num5, num6);
}

int greaterNumOf6Nums(int num1, int num2, int num3, int num4, int num5, int num6){
...
void printResult(int greater_num, int num1, int num2, int num3, int num4, int num5, int num6){
    printf("The greater number of [ %d, %d, %d, %d, %d, %d ] is %d",
            num1, num2, num3, num4, num5, num6, greater_num);
}
